...
import 'register/register_default.dart';
        ...
        children: [
            ...
            children: [
              TextButton(
                  onPressed: (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context)=>const HomeCustom(),
                      )
                    );
                  },
          ...
          Row(
            ...
            children: [
              ...
              TextButton(onPressed: ()=> RegisterDefault.show(context), child: Text("Đăng kí tài khoản",style: TextStyle(fontSize: 18,color: Color(0xFFBB8A0B))))
            ],
          )
        ],
      ),
